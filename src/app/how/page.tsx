...
const deliveryOptions = [
  { emoji: '🌐', title: 'TrackBridge.ai', body: 'Dedicated web interface with full chat history, project views, and team collaboration features.', tag: 'Q3 2026', live: true },
  { emoji: '💬', title: 'Slack', body: 'Ask questions directly in your existing Slack workspace. Get answers without leaving the tool your team lives in.', tag: 'Q3 2026', live: true },
  { emoji: '🔷', title: 'Microsoft Teams', body: 'Native Teams integration for organizations that run on Microsoft 365. Ask from any channel or DM.', tag: 'Roadmap', live: false },
  { emoji: '🔌', title: 'Chrome Extension', body: 'A floating TrackBridge chat window inside your PSA platform. Ask without switching tabs.', tag: 'Roadmap', live: false },
]
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {deliveryOptions.map((d) => (
              <div key={d.title} className="bg-white rounded-card shadow-card p-6 text-center">
                <div className="text-[26px] mb-4" aria-hidden="true">{d.emoji}</div>
