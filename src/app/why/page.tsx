        ...
        <div className="relative bg-cosmos rounded-card px-12 py-16 text-center overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/contact" className="px-7 py-3 rounded-full bg-brand text-white font-semibold text-[15px] tracking-ui shadow-cta hover:opacity-90 transition-opacity">Book a Demo</Link>
              <Link href="/pricing" className="px-7 py-3 rounded-full text-white text-[15px] font-medium tracking-ui border border-ice/25 shadow-ghost-dark hover:bg-white/5 transition-colors">See Pricing</Link>
            </div>
          </div>
        </div>
      </div>
